...
class GoldPostSearchRepository(Protocol):
    ...
    def get_filtered(self, keyword: str, sentiment: str | None = None, platform: str | None = None, language: str | None = None, date_from: date | None = None, date_to: date | None = None, limit: int = 100, offset: int = 0) -> list[GoldPostSearch]: ...
