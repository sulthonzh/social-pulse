...
* separate concatenated .gitignore lines (*.log and .mypy_cache/) ([15ef763](https://github.com/sulthonzh/social-pulse/commit/15ef763516c814b47fbc0b45394ab824a9a7e3dd))
* **tests:** replace deprecated asyncio.get_event_loop with asyncio.run ([cfe44bd](https://github.com/sulthonzh/social-pulse/commit/cfe44bd5a1b4b775d63dede3eee74ec94711bc85))
